    ...
    return (
        <div className="pb-32 space-y-10">
            ...
            <div className="grid grid-cols-2 gap-5">
                {templates.map((template, index) => {
                    ...
                    return (
                        <motion.button
                            ...
                            className={cn(
                                "relative group overflow-hidden bg-card/60 backdrop-blur-xl border border-white/10 p-6 rounded-[2.5rem] shadow-2xl shadow-black/5 hover:shadow-primary/10 transition-all duration-500 text-center flex flex-col items-center space-y-4",
                        ...
                        >
                            ...
                            <div className={cn(
                                "absolute -top-12 -right-12 w-32 h-32 rounded-full blur-3xl opacity-10 transition-all duration-700 group-hover:opacity-25 group-hover:scale-110",
                                template.color || "bg-primary"
                            )} />

                            <div className="flex justify-center w-full">
                                <div className={cn(
                                    "w-16 h-16 rounded-[1.5rem] flex items-center justify-center text-white shadow-xl relative overflow-hidden",
                                    template.color || "bg-primary"
                                )}>
                                    ...
                                    {isApplying ? (
                                        ...
                                        <IconComponent size={28} strokeWidth={2.5} className="relative z-10 transition-transform duration-500 group-hover:scale-110" />
                                    )}
                                </div>
                            </div>
                            ...
                            <div className={cn(
                                "font-black tracking-tighter text-[24px] leading-none flex items-center justify-center gap-1.5",
                                template.type === 'income' ? "text-emerald-500" : "text-foreground"
                            )}>
                                <span className="text-[0.8em] opacity-40 translate-y-[1px]">{template.type === 'income' ? '+' : '-'}</span>
                ...
                >
                    <div className="w-12 h-12 rounded-2xl bg-muted/40 flex items-center justify-center group-hover:bg-primary/10 group-hover:scale-110 transition-all">
                        <Plus size={24} />
                    </div>
                    <span className="text-[10px] font-black uppercase tracking-widest">{t('templates.create_new')}</span>
                </motion.button>
            </div>
