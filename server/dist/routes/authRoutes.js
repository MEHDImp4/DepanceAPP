...
router.post('/register', (0, validate_1.default)(schemas_1.registerSchema), authController.register);
router.post('/login', (0, validate_1.default)(schemas_1.loginSchema), authController.login);
